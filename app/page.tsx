...
const intro = "Entra en un pasadizo secreto donde vuelan drones y se crean gemelos digitales."
...
export default function Home() {
  ...
  return (
    ...
    <main className={styles.main}>
      ...
      Inyecciones de tecnología para tus proyectos inmobiliarios
      </p>
      ...
      <div className={styles.titleimg2}>
